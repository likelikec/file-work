...
CONDITIONS ={
    ...
    "WaferMapDataset": (1, 0),
    "NumberAxis": (1, 0),
    "SunJPEGEncoderAdapter": (1, 0),
    "DataPackageResources_ru": (2, 1),
    "PieSectionEntity": (1, 0),
    "ValueTick": (1, 0),
    "Title": (1, 0),
    "DefaultCategoryDataset": (1, 0),
    "CategoryLabelWidthType": (1, 0),
    "CenterTextMode": (2, 1),
    "DefaultPolarPlotEditor": (1, 0),
    "WaterfallBarRenderer": (1, 0),
    "ChartProgressEvent": (2, 1),
    "DefaultLogAxisEditor": (1, 0),
    "DateRange": (1, 0),
    ...
    "JDBCXYDataset": (1, 0),
    "FlowPlot": (1, 0),
    "XYInversePointerAnnotation": (1, 0),
    "StandardDialScale": (2, 1),
    "HMSNumberFormat": (1, 0),
    "StandardEntityCollection": (2, 1),
    "DefaultTableXYDataset": (1, 0),
    "PaintList": (2, 1),
    "KeyedObject": (2, 1),
    ...
    "FlowDatasetUtils": (1, 0),
    "LegendItemBlockContainer": (1, 0),
    "KeyedValueComparator": (2, 1),
    "PaintUtils": (2, 1),
    "TimeSeriesTableModel": (1, 0),
    ...
    "QuarterDateFormat": (1, 0),
    "ItemLabelAnchor": (1, 0),
    "HistogramBin": (2, 1),
    "YIntervalRenderer": (1, 0),
    "ChartFactory": (1, 0),
    "CategoryMarker": (2, 1),
    "LabelBlock": (1, 0),
    "DefaultKeyedValues2DDataset": (1, 0),
    "XYItemRendererState": (1, 0),
...
def main():
    ...
    target_dir_sym_rf = r"C:\Users\17958\Desktop\jfree项目\sym-xgboost"
    output_file = r"C:\Users\17958\Desktop\jfree项目\sym-xgb.txt"
